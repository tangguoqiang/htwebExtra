...
public class OutpPresc extends OutpPrescKey {
    ...
    private Short providedIndicator;
    ...
    public Short getProvidedIndicator() {
        return providedIndicator;
    }

    public void setProvidedIndicator(Short providedIndicator) {
    ...
    public Short getPressClassBak() {
        return pressClassBak;
    }

    public void setPressClassBak(Short pressClassBak) {
        this.pressClassBak = pressClassBak;
    }
