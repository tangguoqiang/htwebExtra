...
public class OutpOrdersCosts extends OutpOrdersCostsKey {
    ...
    private Short byjAttr;

    private String justRcptNo;

    private String justInsuFlag;
    ...
    public Short getByjAttr() {
        return byjAttr;
    }

    public void setByjAttr(Short byjAttr) {
        this.byjAttr = byjAttr;
    }

    public String getJustRcptNo() {
        return justRcptNo;
    }

    public void setJustRcptNo(String justRcptNo) {
        this.justRcptNo = justRcptNo == null ? null : justRcptNo.trim();
    }

    public String getJustInsuFlag() {
        return justInsuFlag;
    }

    public void setJustInsuFlag(String justInsuFlag) {
        this.justInsuFlag = justInsuFlag == null ? null : justInsuFlag.trim();
    }
}