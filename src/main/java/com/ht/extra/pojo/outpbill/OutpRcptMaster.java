...
public class OutpRcptMaster {
    ...
    private String printOperatorNo;

    private Timestamp printDateTime;
    ...
    public String getPrintOperatorNo() {
        return printOperatorNo;
    }

    public void setPrintOperatorNo(String printOperatorNo) {
        this.printOperatorNo = printOperatorNo == null ? null : printOperatorNo.trim();
    }
    ...
    public void setPrintDateTime(Timestamp printDateTime) {
