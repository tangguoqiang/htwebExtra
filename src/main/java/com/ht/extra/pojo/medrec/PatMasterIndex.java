...
public class PatMasterIndex {
    ...
    public void setCountryTeamCode(String countryTeamCode) {
        this.countryTeamCode = countryTeamCode == null ? null : countryTeamCode.trim();
    }
    ...
    public void setFamilySysno(String familySysno) {
        this.familySysno = familySysno == null ? null : familySysno.trim();
    }
    ...
    public void setHeadOfHousehold(String headOfHousehold) {
        this.headOfHousehold = headOfHousehold == null ? null : headOfHousehold.trim();
    }

    public String getInsurancesNo() {
        return insurancesNo;
    }

    public void setInsurancesNo(String insurancesNo) {
        this.insurancesNo = insurancesNo == null ? null : insurancesNo.trim();
    }
