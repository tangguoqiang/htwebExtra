...
public class ClinicTypeDict {
    ...
    private String clinicTypeUnits;
    ...
    public String getClinicTypeUnits() {
        return clinicTypeUnits;
    }

    public void setClinicTypeUnits(String clinicTypeUnits) {
        this.clinicTypeUnits = clinicTypeUnits == null ? null : clinicTypeUnits.trim();
    }
}